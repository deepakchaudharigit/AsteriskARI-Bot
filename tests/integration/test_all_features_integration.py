...
from src.voice_assistant.ai.websocket_openai_client # Removed Gemini import - using OpenAI
...
class TestCompleteSystemIntegration:
    ...
    async def test_performance_monitoring_complete_cycle(self):
        ...
        latency_stats = monitor.get_latency_stats("openai_api")
    ...
    @pytest.mark.asyncio
    async def test_websocket_openai_client_simulation(self):
