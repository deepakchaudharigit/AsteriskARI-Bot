...
class TestRealServiceIntegration:
    ...
    def setup_real_services(self):
        ...
        required_vars = ["OPENAI_API_KEY", "ARI_BASE_URL", "ARI_USERNAME", "ARI_PASSWORD"]
    ...
    async def test_openai_api_connection(self):
        ...
        try:
            ...
            assert connected, "Failed to connect to OpenAI Realtime API"
    ...
    async def test_production_configuration_validation(self):
        ...
        assert settings.OPENAI_API_KEY is not None, "Google API key not configured"
    ...
    async def test_error_handling_integration(self):
        ...
        invalid_client = OpenAIRealtimeClient(
