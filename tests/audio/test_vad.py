...
class TestVADIntegration:
    ...
    def test_vad_with_conversation_pattern(self, audio_config):
        ...
        vad.energy_threshold = 50  # Very low threshold for test audio
        ...
        energies = [r["energy"] for r in results]; high_energy_chunks = [e > 1000 for e in energies]; assert (True in speech_states) or (True in high_energy_chunks), f"Should detect some speech or high energy. Max energy: {max(energies) if energies else 0}"
