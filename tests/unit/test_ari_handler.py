...
class TestRealTimeARIConfig:
    ...
    def test_default_config(self):
        ...
        assert config.stasis_app == "openai-voice-assistant"
...
class TestARIEvent:
    ...
    def test_ari_event_creation(self, sample_ari_events):
        ...
        assert event.application == "openai-voice-assistant"
...
class TestRealTimeARIHandler:
    ...
    async def test_start_stop_handler(self, test_settings):
        ...
        handler.openai_client.connect = AsyncMock(return_value=True)
        ...
        handler.openai_client.disconnect = AsyncMock()
        ...
        handler.openai_client.disconnect.assert_called_once()
    ...
    async def test_start_handler_failure(self, test_settings):
        ...
        handler.openai_client.connect = AsyncMock(return_value=False)
        handler.external_media_handler.start_server = AsyncMock(return_value=True)
    ...
    async def test_handle_stasis_start(self, test_settings, sample_ari_events):
        ...
        handler.openai_client.start_conversation = AsyncMock(return_value="session-123")
        ...
        handler.openai_client.start_conversation.assert_called_once()
    ...
    @pytest.mark.asyncio
    async def test_openai_audio_response_handling(self, test_settings):
        ...
        await handler._handle_openai_audio_response({
    ...
    async def test_user_speech_events(self, test_settings):
        ...
        handler.openai_client.commit_audio_buffer = AsyncMock()
        handler.openai_client.create_response = AsyncMock()
        ...
        handler.openai_client.commit_audio_buffer.assert_called_once()
        handler.openai_client.create_response.assert_called_once()
    ...
    def test_get_system_status(self, test_settings):
        ...
        handler.openai_client.get_connection_status = Mock(return_value={"connected": True})
