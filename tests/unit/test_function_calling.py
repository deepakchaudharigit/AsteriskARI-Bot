...
from src.voice_assistant.ai.function_calling import (
    ...
    FunctionCallHandler, openai_function, function_registry, function_call_handler
)
...
class TestFunctionDefinition:
    ...
    def test_to_openai_format(self):
        ...
        gemini_format = definition.to_openai_format()
...
class TestGeminiFunctionDecorator:
    """Test cases for openai_function decorator"""
