"""
Setup script for the Real-time OpenAI Voice Assistant with Asterisk ARI.
...
class RealtimeSetup:
    """Setup and validation for real-time OpenAI Voice Assistant"""
    ...
    def run_setup(self) -> bool:
        ...
        try:
            print("\\n" + "="*80)
            print("🚀 OPENAI VOICE ASSISTANT - REAL-TIME SETUP")
            print("="*80)
    ...
    def validate_configuration(self) -> bool:
        ...
        try:
            ...
            if not self.settings.OPENAI_API_KEY or self.settings.OPENAI_API_KEY == "your-openai-api-key-here":
            ...
            if self.settings.audio_sample_rate != 16000:
                ...
                print("✅ Sample rate: 16000Hz (optimal for OpenAI Realtime)")
    ...
    def test_connections(self) -> bool:
        ...
        try:
            import openai
            genai.configure(api_key=self.settings.OPENAI_API_KEY)
            print("✅ OpenAI library configured")
        except Exception as e:
...
# Start script for OpenAI Voice Assistant - Real-time ARI

echo "🚀 Starting OpenAI Voice Assistant - Real-time ARI..."
...
REM Start script for OpenAI Voice Assistant - Real-time ARI
...
"""
    ...
    def print_next_steps(self):
        ...
        print("   - Set your Google API key (OPENAI_API_KEY)")
        ...
        print("   - Call extension 1000 for OpenAI conversation")
