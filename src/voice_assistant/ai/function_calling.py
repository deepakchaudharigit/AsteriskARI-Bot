"""
Function Calling System for OpenAI Realtime API.
...
class FunctionDefinition:
    ...
    def to_openai_format(self) -> Dict[str, Any]:
        """Convert to OpenAI API function definition format"""
        properties = {}
        required_params = []
...
class FunctionRegistry:
    ...
    def get_all_definitions(self) -> List[Dict[str, Any]]:
        ...
        return [definition.to_openai_format() for definition in self.function_definitions.values()]
...
class FunctionCallHandler:
    ...
    async def handle_function_call(self, function_call_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Handle a function call from OpenAI API.
        
        Args:
            function_call_data: Function call data from OpenAI
            
        Returns:
            Function response in OpenAI format
        """
        try:
    ...
    def _format_result(self, result: Any) -> str:
        """Format function result for OpenAI API"""
...
def openai_function(name: str, description: str, parameters: List[FunctionParameter], 
                   behavior: str = "NON_BLOCKING"):
    """Decorator to create an OpenAI function from a regular function"""
