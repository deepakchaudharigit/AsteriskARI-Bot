...
class VoiceAssistant:
    ...
    def __init__(self, 
        ...
        self.openai_client = OpenAIRealtimeClient(api_key=self.settings.openai_api_key)
    ...
    def _process_user_input(self, user_text: str) -> str:
        ...
        logger.debug("Processing user input with OpenAI...")
        
        try:
            response = self.openai_client.generate_response(user_text)
    ...
    def _get_welcome_message(self) -> str:
        """Get welcome message"""
        return f"Hello! I'm {self.settings.assistant_name}, your voice assistant powered by OpenAI GPT-4 Realtime. I'm ready to help you with any questions or tasks. What would you like to talk about?"
