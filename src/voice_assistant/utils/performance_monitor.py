...
class PerformanceMonitor:
    ...
    def start_operation(self, operation_type: str, operation_id: str = None) -> str:
        ...
        Args:
            operation_type: Type of operation (e.g., 'openai_api', 'speech_recognition')
    ...
    def end_operation(self, operation_id: str, operation_type: str, success: bool = True):
        ...
        with self._lock:
            ...
            if operation_type == "openai_api":
                self.metrics.openai_api_calls += 1
                self.metrics.openai_api_latency += latency
    ...
    def get_current_metrics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "average_openai_latency": (
                    self.metrics.openai_api_latency / max(1, self.metrics.openai_api_calls)
                ),
                ...
                "operations_per_second": (
                    max(
                        ...
                        (self.metrics.openai_api_calls + self.metrics.speech_recognition_calls + 
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "latency_stats": {
                "openai_api": self.get_latency_stats("openai_api"),
            ...
            "health_indicators": {
                ...
                "latency_healthy": current_metrics["average_openai_latency"] < 2.0
            }
        }
