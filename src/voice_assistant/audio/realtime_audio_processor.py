"""
Real-time audio processing for Asterisk ARI and OpenAI Realtime API integration.
...
class RealTimeAudioProcessor:
    """Real-time audio processor for Asterisk ARI and OpenAI Realtime integration"""
