...
- **Real-time Voice Processing**: Low-latency audio processing with OpenAI GPT-4 Realtime
...
For technical support, contact the NPCL IT team or refer to the deployment documentation.
    ...
    openapi_schema["tags"] = [
        ...
        {
            "name": "AI Integration",
            "description": "OpenAI integration and response generation"
        },
        {
            "name": "System Health",
        ...
        "sections": {
            "environment_variables": {
                ...
                "variables": {
                    "OPENAI_API_KEY": {
                        "required": True,
                        "description": "OpenAI API key for GPT-4 Realtime access",
                        "example": "AIzaSyD...",
                        "security": "sensitive"
                    },
                    "ARI_BASE_URL": {
